...
autosnips = {
  ...
  s({ trig = "\\varphii", name = "\\varphi_i", hidden = true }, { t "\\varphi_{i}" }, { condition = tex.in_mathzone }),
  s(
  ...
  s({ trig = "||", name = "mid |", wordTrig = false, hidden = true }, { t "\\mid " }, { condition = tex.in_mathzone }),
  s(
  ...
  s({ trig = "cap", name = "cap", wordTrig = false, hidden = true }, { t "\\cap " }, { condition = tex.in_mathzone }),
  s({ trig = "cup", name = "cup", wordTrig = false, hidden = true }, { t "\\cup " }, { condition = tex.in_mathzone }),
  s(
