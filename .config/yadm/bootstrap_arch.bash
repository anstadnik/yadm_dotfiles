...
paru -Sy --noconfirm git neofetch neovim-git tmux curl fd htop fish zoxide bat pyright rust-analyzer openssh python unzip npm topgrade yazi lsd macchina thefuck micromamba fzf
