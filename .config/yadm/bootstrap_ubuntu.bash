...
sudo apt update
sudo -E apt install -y build-essential neofetch python3-pip tmux curl fd-find htop systemd-coredump fish bat unar neovim unzip nodejs thefuck fzf cmake rust-lsd
